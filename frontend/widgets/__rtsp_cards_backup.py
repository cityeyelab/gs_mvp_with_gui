...
class RtspCard(customtkinter.CTkFrame):
    ...
    def update_frame(self):
        ...
        self.lbl.after(2560, self.update_frame)
...
class RtspMainView(customtkinter.CTkFrame):
    ...
    def run_video(self):
        ...
        while True:
            ...
            if self.selected_cam_num == 1:
                self.current_frame = frame1.copy()
            if self.selected_cam_num == 2:
                self.current_frame = frame2.copy()
            if self.selected_cam_num == 3:
                self.current_frame = frame3.copy()
                
            # self.drawing_result_ques[3].put(frame1)
            # self.drawing_result_ques[4].put(frame2)
            # self.drawing_result_ques[5].put(frame3)
    ...
    def update_frame(self):
        ...
        self.lbl.after(640, self.update_frame)
...
class BpView(customtkinter.CTkFrame):
    ...
    def update_frame(self):
        ...
        self.lbl.after(1280, self.update_frame)
