...
if __name__ == '__main__':    
    ...
    p1 = Process(target = create_frontend, args= (shared_variables.args, drawing_result_ques), daemon=False)
    p2 = Process(target = create_backend, args= (shared_variables.args, drawing_result_ques), daemon=False)
