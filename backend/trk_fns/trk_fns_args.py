...
from ..map_vars import area1_global_inout_map, area1_car_wash_waiting_map, area1_place0_map, area1_inner_map
from ..map_vars import area3_global_inout_map, area3_car_wash_waiting_map, area3_inner_map
from ..map_vars import area4_global_inout_map, area4_car_wash_waiting_map, area4_electric_vehicle_charging_map, area4_car_interior_washing_map, area4_inner_map
...
class TrackingVariables():
    __slots__ = ['area_number', 'slope', 'glb_inout_map', 'non_global_maps_names', 'non_global_maps', 'inner_map']
    ...
    def __init__(self, data_dict: dict) -> None:
        ...
        self.inner_map = data_dict['inner_map']
